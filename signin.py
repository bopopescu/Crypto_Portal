...
class SignIn(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.default_font = font = fonts.Font(family="Times", size=15)
    ...
    def do_login(self):
        ...
        if result == "You have successfully logged in.":
            ...
            self.current_username = self.username.get()
            self.controller.set_current_username(self.username.get())
