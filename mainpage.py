...
class MainPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        profile = tk.Button(self.options_frame, text="Profile Settings", command=lambda: controller.show_frame("Profile"))
        ...
        self.newsFrame.grid(column="1",columnspan="2",row="2", rowspan="1")
        #self.newsFrame.rowconfigure(row=2, weight=1)
        self.options = []
