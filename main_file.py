...
class SignIn(tk.Frame):
    def __init__(self, parent, controller):
        ...
        username_entry = tk.Entry(self, bg=self.default_bg, font=self.default_font, textvariable=self.username, fg="green")
        ...
        password_entry = tk.Entry(self, bg=self.default_bg, font=self.default_font, show="*", textvariable=self.password,fg="green")
        ...
        tk.Label(self, text="",textvariable=self.messege)

        tk.Button(self,bg=self.default_bg,fg="blue",text="Login",font=self.default_font,bd=0,command=self.do_login).grid(row=3,column=0,sticky="N",ipady=6, pady=(2))
        self.rowconfigure(3, weight=1)

        tk.Button(self,text="Forgot password?",bg=self.default_bg,bd=0,fg="red",font= self.default_font,command=self.do_forgot_password).grid(row=4,column=0,sticky="N",ipadx=35,ipady=3)
        self.rowconfigure(4, weight=1)
        tk.Button(self, text="Back", font=self.default_font, fg="green",bg=self.default_bg, bd=3, command=lambda:self.controller.show_frame("StartPage")).grid(row=5,column=0,sticky="S",ipadx=15,ipady=5,pady=(0, 100))
    ...
    def do_login(self):
        ...
        if login_check(self.username.get(),self.username.get()):
            ...
            self.messege.config(text="incorrect username or password")
...
class StartPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        button1 = tk.Button(self, text="Sign in",bg=self.default_bg,fg="green",font=button_font,command=lambda: controller.show_frame("SignIn"))
        button1.grid(row=1,column=0,ipadx=30,ipady=8)
        self.rowconfigure(1, weight=1)

        button2 = tk.Button(self, text="Sign up",fg="green",bg=self.default_bg,font=button_font,command=lambda: controller.show_frame("SignUp"))
...
class SignUp(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        tk.Label(self,text="Name",font=self.default_font,fg=self.default_fg,bg=self.default_bg).grid(column=0,row=1,sticky="E")
        tk.Label(self, text="Last Name", font=self.default_font,fg=self.default_fg,bg=self.default_bg).grid(column=0,row=2,sticky="E", )
        tk.Label(self, text="Phone", font=self.default_font,fg=self.default_fg,bg=self.default_bg).grid(column=0,row=3,sticky="E")
        tk.Label(self, text="Email", font=self.default_font,fg=self.default_fg,bg=self.default_bg).grid(column=0,row=4,sticky="E")
        tk.Label(self, text="Password", font=self.default_font,fg=self.default_fg,bg=self.default_bg).grid(column=0,row=5,sticky="E")
        tk.Label(self, text="Re-enter password", font=self.default_font,fg=self.default_fg,bg=self.default_bg).grid(column=0,row=6,sticky="E")
        ...
        name_ent = tk.Entry(self, textvariable=self.name,bg=self.default_bg,font=self.default_font)
        name_ent.grid(column=1, row=1,sticky="W")

        self.last_name = tk.StringVar()
        last_name_ent = tk.Entry(self, textvariable=self.last_name,bg=self.default_bg,font=self.default_font)
        last_name_ent.grid(column=1,row=2,sticky="W")

        self.phone = tk.StringVar()
        phone_ent = tk.Entry(self,textvariable=self.phone,bg=self.default_bg,font=self.default_font)
        phone_ent.grid(column=1,row=3,sticky="W")
        ...
        create_profile_btn.grid(column=0,columnspan=2,row=7,pady=(15,0),ipadx=10,ipady=4)
